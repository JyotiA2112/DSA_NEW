...
public class Student {
    ...
    public static void main(String[] args) {
        list.stream().filter(data -> data.getFirstName().startsWith("A")).collect(Collectors.toList());
        list.stream().collect(Collectors.groupingBy(Student::getFirstName));
        list.stream().count();
        list.stream().mapToInt(data -> data.getAge()).max();
